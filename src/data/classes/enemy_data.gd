...
@export var base_speed: int = 10 # Controls who strikes first in the turn logs

@export_group("Loot Table Calculations")
## The YARD StringNames of items this enemy can drop (maps to item_registry string IDs)
